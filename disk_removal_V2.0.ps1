...
##### Import-CSV C:\powercli\lab\harddisk2.csv | Foreach-Object { 
#
...
if ( $VCStatus ) {
       ...
       remove_harddisk
        ...
        ### send-mailmessage -from "powercli_reclaim_script@----------.com" -to "---------------.com" -subject "This is output of datastore reclaim script executed on vCenter Server $vCenter by user $vcuserName  " -body $output -priority High -DNO onSuccess, onFailure -smtpServer ------------
        }
        else {
        }
